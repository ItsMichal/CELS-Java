...
class Food {
	...
	Food(Simulation tsa, float x, float y, int ratio) {
		this.tsa = tsa;
	...
	public void run(ArrayList<Food> h) {
		flock(h);
		update();
		borders();
		render();
	...
	public void flock(ArrayList<Food> h) {
	...
	public PVector separate(ArrayList<Food> h) {
	...
	public PVector align(ArrayList<Food> h) {
	...
	public PVector cohesion(ArrayList<Food> h) {
		float neighbordist = 50;
